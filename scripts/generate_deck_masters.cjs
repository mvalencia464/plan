...
riceProjects.push(
  ...
  // Example RICE requested by user
  { id: 'rp-5', name: 'Launch "Deck Care" Maintenance Package', reach: 200, impact: 1.5, confidence: 80, effort: 2, score: (200*1.5*0.8)/2 } 
);
...
fs.writeFileSync('update_deck_masters_plan.sql', sql);
console.log('SQL file generated: update_deck_masters_plan.sql');